...
macro(caffe_set_caffe_link)
  if(BUILD_SHARED_LIBS)
	  set(Caffe_LINK caffe CACHE INTERNAL "caffe link")
  else()
    if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
	    set(Caffe_LINK -Wl,-force_load caffe CACHE INTERNAL "caffe link")
    elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
	    set(Caffe_LINK -Wl,--whole-archive caffe -Wl,--no-whole-archive CACHE INTERNAL "caffe link")
    endif()
  endif()
endmacro()
################################################################################################
