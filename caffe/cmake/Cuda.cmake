...
set(Caffe_known_gpu_archs "35 50 60 61 70 75 80 86")
...
list(APPEND Caffe_LINKER_LIBS PUBLIC ${CUDA_curand_LIBRARY} ${CUDA_CUBLAS_LIBRARIES})
...
string(APPEND CMAKE_CUDA_FLAGS " ${NVCC_FLAGS_EXTRA}")
