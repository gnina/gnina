...
// void Flex_LSTMLayer<Dtype>::FillUnrolledNet(NetParameter* net_param) const {
  //actually just fills in a single timestep...how to deal with output blobs?
  // const int num_output = this->layer_param_.recurrent_param().num_output();
  // CHECK_GT(num_output, 0) << "num_output must be positive";
  //TODO: support different filler for different gates
...
// 
// template<typename Dtype>
// template<Flex_LSTMLayer<Dtype>::AccessPattern apat>
