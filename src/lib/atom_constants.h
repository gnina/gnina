...
enum type {
	...
	Sulfer, //S_S_S_P,
	SulferAcceptor, //S_SA_S_P, XS doesn't do sulfor acceptors
	Phosphorus, //P_P_P_P,
	Flourine, //F_F_F_H,
	Chlorine, //Cl_Cl_Cl_H,
	Bromine, //Br_Br_Br_H,
