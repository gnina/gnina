...
struct parallel_mc_aux {
	...
	parallel_mc_aux(const monte_carlo* mc_, const precalculate* p_, const igrid* ig_, const vec* corner1_, const vec* corner2_, parallel_progress* pg_)
...
void parallel_mc::operator()(const model& m, output_container& out, const precalculate& p, const igrid& ig, const vec& corner1, const vec& corner2, rng& generator) const {
